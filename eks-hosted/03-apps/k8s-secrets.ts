...
export const provider = new k8s.Provider("provider", { kubeconfig: config.kubeconfig, deleteUnreachable: true });
...
export const secretsIntegration = configurePulumiSecretProvider(config, provider)
